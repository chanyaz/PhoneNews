...
public final class ThreadPoolUtils {
    ...
    private static class SingletonHolder {
        private final static ThreadPoolUtils sInstance = new ThreadPoolUtils();
    }
    ...
    public static void init() {
        if (SingletonHolder.sInstance.exec == null) {
            ThreadPoolExecutor threadPool = new ThreadPoolExecutor(CORE_POOL_SIZE, MAXIMUM_POOL_SIZE, KEEP_ALIVE,
                    TimeUnit.SECONDS, new SynchronousQueue<Runnable>(),
                    threadFactory("ThreadPoolUtils", false));
            threadPool.allowCoreThreadTimeOut(true);
            SingletonHolder.sInstance.exec = threadPool;
        }
        if (SingletonHolder.sInstance.scheduleExec == null) {
            SingletonHolder.sInstance.scheduleExec =
