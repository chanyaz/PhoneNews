package com.ronin.pullrefreshlibrary;
...
import com.ronin.pullrefreshlibrary.refresh_view.BaseRefreshView;
import com.ronin.pullrefreshlibrary.refresh_view.SunRefreshView;
...
public class PullToRefreshView extends ViewGroup {
    ...
    public PullToRefreshView(final Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        if (mOnClickListener != null) {
            mRefreshView.setOnClickListener(mOnClickListener);
        }
    ...
    public void initImagesFilePath(final String sunPath, final String skyPath, final String buindingPath) {
        if (mBaseRefreshView != null) {
            ((SunRefreshView) mBaseRefreshView).setImagesPath(sunPath, skyPath, buindingPath);
        }
    }
